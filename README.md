...
```bash
curl -LO "https://github.com/gerardcl/rodalies-cli/releases/download/1.1.1/rodalies-cli-linux-amd64" && \
...
```bash
curl -LO "https://github.com/gerardcl/rodalies-cli/releases/download/1.1.1/rodalies-cli-darwin-amd64" && \
...
```bash
curl -LO "https://github.com/gerardcl/rodalies-cli/releases/download/1.1.1/rodalies-cli-windows-amd64.exe" && \
...
✅ You are running the latest rodalies-cli, version 1.1.1! yayy
